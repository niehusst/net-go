...
var $author$project$Model$Board$getPositionLeftFrom = function (index) {
	return index - 1;
};
var $author$project$Model$Board$getPositionRightFrom = function (index) {
	return index + 1;
};
...
var $author$project$Logic$isSurroundedByEnemyOrWall = F3(
	function (boardData, visited, position) {
		var updatedVisited = A2($elm$core$Set$insert, position, visited);
		...
		var alreadySeen = A2($elm$core$Set$member, position, visited);
		if (alreadySeen) {
			return true;
		} else {
			if (piece.$ === 'Just') {
				var stonePiece = piece.a;
				return _Utils_eq(stonePiece, playerPiece) ? A2(
					$elm$core$List$all,
					A2($author$project$Logic$isSurroundedByEnemyOrWall, boardData, updatedVisited),
					_List_fromArray(
						[
							...
							$author$project$Model$Board$getPositionRightFrom(position),
							$author$project$Model$Board$getPositionLeftFrom(position)
						])) : (_Utils_eq(stonePiece, enemyPiece) ? true : false);
			} else {
				return true;
			}
		}
...
var $author$project$Logic$legalPlayChecks = _List_fromArray(
	[
		...
		F3(
		function (piece, position, game) {
			var seenSet = $elm$core$Set$empty;
			var potentialGameState = _Utils_update(
				game,
				{
			...
			return (!A3($author$project$Logic$isSurroundedByEnemyOrWall, potentialGameState, seenSet, position)) ? $author$project$Logic$okay : _Utils_Tuple2(
				false,
				$elm$core$Maybe$Just(checkMessage));
		})
	]);
...
var $author$project$Page$GamePlay$viewBuildBoard = function (model) {
	...
	var gridStyle = A2(
		$elm$core$String$join,
		' ',
		A2($elm$core$List$repeat, intSize, 'auto'));
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Play Go online with a friend!')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('It\'s pretty '),
						A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Return to home page')
						]))
				]))
		]));
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"HomePageMsg":["Page.Home.Msg"],"GamePlayPageMsg":["Page.GamePlay.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Page.GamePlay.Msg":{"args":[],"tags":{"PlayPiece":["Basics.Int"],"PlayPass":[]}},"Page.Home.Msg":{"args":[],"tags":{"Placeholder":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));